...
class OutputResults{
          ...
          std::vector<double> verticesServicesTimeOf2Approx;
          ...
          std::vector<double> verticesServicesTimeOfSqrBApprox;
          ...
          std::vector<double> verticesServicesTimeOfGreedy;
          ...
          std::vector<double> verticesServicesTimeOfGreedyRandom;
          
          //Declare compute functions for algorithms 
          void compute2Approx(Graph G, std::vector<std::vector<double>> edgesWeights, std::vector<std::pair<double, double>> verticesCoordinationsOfAlg, std::vector<double> verticesPrizesOfAlg, std::vector<double> verticesSizesOfAlg, std::vector<double> verticesServicesTimeOfAlg, std::vector<int>& verticesOf2ApproxTemp, double& costOf2ApproxTemp, double& prizeOf2ApproxTemp, double& sizeOf2ApproxTemp);
          
          void computeSqrBApprox(std::vector<std::pair<double, double>> verticesCoordinationsOfAlg, std::vector<double> verticesPrizesOfAlg, std::vector<double> verticesSizesOfAlg, std::vector<double> verticesServicesTimeOfAlg, std::vector<int>& verticesOfAlg, double& costOfAlg, double& prizeOfAlg, double& sizeOfAlg);
          
          void computeGreedy(std::vector<std::pair<double, double>> verticesCoordinationsOfAlg, std::vector<double> verticesPrizesOfAlg, std::vector<double> verticesSizesOfAlg, std::vector<double> verticesServicesTimeOfAlg, std::vector<int>& verticesOfAlg, double& costOfAlg, double& prizeOfAlg, double& sizeOfAlg);
          
          void computeGreedyRandom(std::vector<std::pair<double, double>> verticesCoordinationsOfAlg, std::vector<double> verticesPrizesOfAlg, std::vector<double> verticesSizesOfAlg, std::vector<double> verticesServicesTimeOfAlg, std::vector<int>& verticesOfAlg, double& costOfAlg, double& prizeOfAlg, double& sizeOfAlg);
          ...
          public:
               ...
               void removeCoveredVertices(std::vector<int> coveredVertices, std::vector<std::pair<double, double>>& verticesCoordinationOfAlg, std::vector<double>& verticesPrizesOfAlg, std::vector<double>& verticesSizeOfAlg, std::vector<double>& verticesServicesTimeOfAlg);
               
               
               void binarySearch(std::vector<std::pair<double, double>> verticesCoordinationsOfAlg, std::vector<double> verticesPrizesOfAlg, std::vector<double> verticesSizesOfAlg, std::vector<double> verticesServicesTimeOfAlg, std::string nameOfAlg, std::vector<int>& verticesOfAlg, double& costOfAlg, double& prizeOfAlg, double& sizeOfAlg);
