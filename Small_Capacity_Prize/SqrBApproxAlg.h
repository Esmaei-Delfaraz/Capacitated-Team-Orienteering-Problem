...
class SqrBApproxAlg{
     ...
     public:
         ...
         //Constructor
         SqrBApproxAlg(double capacity, double budget, std::vector<std::pair<double, double>> verticesCoordinations, std::vector<double> verticesPrizes, std::vector<double> verticesSizes, int numThresholds, double subsetSizeFactor, int numThreads);
